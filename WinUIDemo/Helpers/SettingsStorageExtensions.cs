...
public static class SettingsStorageExtensions
{
    ...
    public static async Task SaveAsync<T>(this StorageFolder folder, string name, T content)
    {
        ...
        var fileContent = content is not null ? await Json.StringifyAsync(content) : string.Empty;
    ...
    {
        settings.SaveString(key, value is not null ? await Json.StringifyAsync(value) : string.Empty);
    }
